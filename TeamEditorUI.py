...
class Ui_TeamAndScheduleEditor(object):
    def setupUi(self, TeamAndScheduleEditor):
        ...
        TeamAndScheduleEditor.resize(699, 572)
        ...
        self.scheduleEditor = QtWidgets.QListWidget(TeamAndScheduleEditor)
        self.scheduleEditor.setGeometry(QtCore.QRect(20, 280, 256, 192))
